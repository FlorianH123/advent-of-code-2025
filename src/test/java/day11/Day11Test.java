...
public class Day11Test {
    ...
    void testResultPart1() throws IOException {
        final var input = InputUtils.readInputFile(Path.of("day11/example-input-part1.txt"));
    ...
    void testResultPart2() throws IOException {
        final var input = InputUtils.readInputFile(Path.of("day11/example-input-part2.txt"));
